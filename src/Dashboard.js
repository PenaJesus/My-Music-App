        ...
        return (
            <div className="Dashboard">
                <Card className="cardContainer">
                    ...
                    <Switch onClick={this.onClickHandler} value={this.state.isOnline} />
                </Card>
                ...
                <Card className="cardContainer">
                    ...
                    <Slider onChange={this.handleVolumeChange} onDragStop={this.handleDragStop} defaultValue={this.state.volume} valueLabelDisplay="auto" step={10} min={0} max={100} />
                </Card>
